...
public class marketsave {
    ...
    protected ArrayList<checkpoint5_stock> stocks = new ArrayList<>();
    // Description : The trading bot of this market.
    trading_bot tb;
    // Description : The constructor of market.
    public marketsave(String market_name, ArrayList<String[]> trading_data,HashMap<String, String> index_to_market) {
    ...
    // Search for stock
    public checkpoint5_stock search_stock(String index){
        /*********************************The TODO This Time (Checkpoint5) ********************************
         * 
        ...
        checkpoint5_stock find= new checkpoint5_stock("find","find1");
    ...
    public void add_stocks() {
        ...
        String[] temp;
        temp=stop.split(",");
        checkpoint5_stock a1=new checkpoint5_stock(temp[0],temp[1]);
        this.stocks.add(a1);
        // System.out.println(stocks.get(i).index+" , "+stocks.get(i).name);
        // i++;
        }
        }
    ...
    public class trading_bot {
        ...
        exp.put("APOL","NASDAQ");        
        try{
        ArrayList<checkpoint5_stock> stocks = new ArrayList<>();
        if(exp.get(d1.get(0)[2]).equals("DJI")){   
        FileReader fileReader = new FileReader("DJI.csv");
        BufferedReader buff = new BufferedReader(fileReader);
        String stop=buff.readLine();
        while((stop=buff.readLine())!=null){
        ...
        if(exp.get(d1.get(0)[2]).equals("NASDAQ")){   
        FileReader fileReader = new FileReader("NASDAQ.csv");
        BufferedReader buff = new BufferedReader(fileReader);
        String stop=buff.readLine();
        while((stop=buff.readLine())!=null){
        ...
        for(int c1=0;c1<stocks.size();c1++){
            ...
            for(int x=0;x<d1.size();x++){   
                ...
                temp=d1.get(x)[2];
                //System.out.println(temp+" "+exp1.get(c1));

                if(exp1.get(c1).equals(temp)){

                        count=count+1;       
                        if(count==2){
                                //System.out.println(exp1.get(c1));    
                                no.add(exp1.get(c1));
    ...
    //     for(int a1=0;a1<no.size();a1++){
    //     System.out.println(a1+" "+no.get(a1));

    // }
    // System.out.println("the d1.get(0)="+d1.get(0)[0]);
        ...
        //for(int a1=0;a1<fdata.size();a1++){
        //System.out.println(fdata.get(a1)[0]+" "+fdata.get(a1)[1]+" "+fdata.get(a1)[2]+" "+fdata.get(a1)[3]+" "+fdata.get(a1)[4]);
        //}
